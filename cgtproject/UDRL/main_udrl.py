...
def main():
    ...
    # Step 2: Generate training data from the trajectory.
    training_data = generate_training_data(trajectory)
    print("Number of training samples:", len(training_data))
    
    # Step 3: Create and train the UDRL policy network.
    ...
    # Step 4: Use the trained policy for inference.
